...
const sheets_service_1 = require("../../background/sheets-service");
...
describe('Google Sheets API Integration', () => {
    ...
    beforeEach(() => {
        ...
        sheetsService = new sheets_service_1.GoogleSheetsService(mockGetToken);
    ...
    describe('Reading event data from existing Google Sheet', () => {
        it('should read event data successfully', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(expect.stringContaining('test-sheet-id'), expect.objectContaining({
    ...
    describe('Writing updates to Google Sheet', () => {
        it('should update event data successfully', async () => {
            ...
            expect(fetch).toHaveBeenCalledWith(expect.stringContaining('test-sheet-id/values'), expect.objectContaining({
                method: 'PUT',
                headers: expect.objectContaining({
                    'Authorization': 'Bearer mock_access_token',
    ...
    describe('Append to event log', () => {
        it('should append log entry successfully', async () => {
            ...
            await expect(sheetsService.appendToEventLog('test-sheet-id', 'Test log entry'))
                .resolves.not.toThrow();
            expect(fetch).toHaveBeenCalledWith(expect.stringContaining('test-sheet-id/values/Event Log!A:C:append'), expect.objectContaining({
                method: 'POST',
...
//# sourceMappingURL=sheets-api.integration.test.js.map