...
exports.mockMessageError = exports.mockMessageResponse = exports.mockStorageError = exports.mockStorageData = void 0;
...
exports.mockStorageData = mockStorageData;
const mockStorageError = (error) => {
    mockChrome.storage.local.get.mockRejectedValue(error);
    mockChrome.storage.local.set.mockRejectedValue(error);
};
exports.mockStorageError = mockStorageError;
const mockMessageResponse = (response) => {
    mockChrome.runtime.sendMessage.mockResolvedValue(response);
};
exports.mockMessageResponse = mockMessageResponse;
const mockMessageError = (error) => {
    mockChrome.runtime.sendMessage.mockRejectedValue(error);
};
exports.mockMessageError = mockMessageError;
