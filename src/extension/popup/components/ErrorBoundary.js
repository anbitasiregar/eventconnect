...
class ErrorBoundary extends react_1.default.Component {
    ...
    render() {
        if (this.state.hasError) {
            return (<div className="extension-popup bg-white">
          <div className="flex flex-col items-center justify-center h-full p-6 text-center">
            ...
            <div className="space-y-2">
              <Button_1.Button onClick={() => this.setState({ hasError: false })} className="w-full">
                Try Again
              </Button_1.Button>
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (<details className="mt-4 text-left w-full">
